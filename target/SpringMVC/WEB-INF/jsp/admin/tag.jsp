...
<script src="<%=request.getContextPath()%>/static/editor/js/jquery.min.js" type="text/javascript"></script>
...
<script>
    ...
    var active = {
        editor: function () {
            ...
            layer.open({
                ...
                yes: function (index, layero) {
                    ...
                    $.ajax({
                        url: '/Quilt/admin/article/tag/mod/' + tid,
                        data: tag,
                        cache: false,
                        dataType: "json",
        ...
        insert: function () {
            ...
            if (tagName) {
                $.ajax({
                    url: '/Quilt/admin/article/tag/add',
                    data: {
                        'tagName': tagName,
                        'fontSize': fontSize,
                        'fontColor': fontColor
