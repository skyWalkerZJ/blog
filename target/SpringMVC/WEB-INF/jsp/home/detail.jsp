...
<div id="sidebar">
    ...
    <div class="author-info hide">
        ...
        <div class="author-info__avatar text-center">
            <img src="<%=request.getContextPath()%>/static/images/head.jpg" width="100px" height="100px" />
        </div>
        ...
        <div class="follow-button">
            <a href="https://github.com/William-Ramsay">Follow Me</a>
        </div>
        <hr />
...
<div id="content-outer">
    <div id="top-container" style="background-image:url(<%=request.getContextPath()%>/static/images/index/detail.jpg)">

        <div id="page-header">
            <span class="pull-left"><strong></h2><a href="<%=request.getContextPath()%>/">UESTC_SPACE</a></strong></span>
