...
public class ArticleController {
    ...
    public Result writeNewArticle(HttpSession session,
                                  ...
                                  @RequestParam(value = "articleTagId" ,required = false) Integer[] articleTagId) throws MessagingException, GeneralSecurityException, IOException {
        ...
        if(user == null){
            ...
            articleWithBLOBs.setCreateTime(new Date());
            articleWithBLOBs.setUpdateTime(new Date());
            ...
            if (r == 1) {
                //文章成功发布就发送邮件
                emailService.SendEmail(articleTitle);
